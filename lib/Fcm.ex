defmodule FCM do
  ...
  ```
  """
  @spec push(String.t | [String.t], Map.t | Keyword.t) :: { :ok, Map.t } | { :error, term }
  def push(registration_ids, options \\ %{}) do
  ...
  defp headers(:fcm) do
    api_key = Application.get_env(:spotlight_api, :fcm_key)
